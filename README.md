...
2. Read train and test dataset into R environment.
3. Read variable names into R envrionment.
4. Read subject index into R environment.
...
9. From the data set now formed, create a second, independent tidy data set with the average of each variable for each activity and each subject.
